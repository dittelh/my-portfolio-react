...
import './DitteMovingSVG.css';

const DitteMovingSVG = () => {
  ...
  useEffect(() => {
    ...
    const dom = {
      ...
      eyebrowLeft: document.querySelector('.left_eyebrow'),
      eyebrowRight: document.querySelector('.right_eyebrow'),
    };
  ...
  return (
    <div className="container ditteSVG">
      {/* Your JSX structure here */}
      <svg
        xmlns="http://www.w3.org/2000/svg"
        xmlnsXlink="http://www.w3.org/1999/xlink"
        viewBox="0 0 930.66 644.99"
      >
        <defs>
          <linearGradient
          ...
          >
            <stop offset={0} stopColor="#fff87f" />
            <stop offset={0.06} stopColor="#f9f27c" stopOpacity={0.98} />
            <stop offset={0.13} stopColor="#eae474" stopOpacity={0.92} />
            <stop offset={0.21} stopColor="#d1cc68" stopOpacity={0.82} />
            <stop offset={0.29} stopColor="#afaa57" stopOpacity={0.69} />
            <stop offset={0.38} stopColor="#827e40" stopOpacity={0.51} />
            <stop offset={0.47} stopColor="#4b4925" stopOpacity={0.3} />
            <stop offset={0.56} stopColor="#0c0b06" stopOpacity={0.05} />
        ...
        >
          ...
          <g className="shirt">
            <path
              className="innershirt"
              d="m762.44,467.59h-203.97c.09-.47-.19-.84-.35-1.23-2.54-6.23-3.93-12.66-3.87-19.42.09-11.37.03-22.73.03-34.1,0-24.78,0-49.56-.01-74.34,3.76-1.42,7.52-2.84,11.29-4.26.17-.02.35,0,.51-.06,4.07-1.38,8.12-2.78,12.19-4.15,11.84-4,23.84-7.47,35.91-10.7,1.03.1,92.41,4.57,91.84-.16.5.12,3.08.4,3.57.54,1.93.56,3.85,1.13,5.78,1.7.52.43,2.51.84,3.12,1.03,4.88,1.51,8.45,2.64,13.33,4.14,3.6,1.11,7.19,1.72,10.78,2.85.28.11,1.8.36,2.09.45,7.34,2.47,13.4,4.43,20.64,7.17,1.12.43,1.58.93,1.58,2.22-.04,35.85-.04,72.75-.03,108.6,0,2.44-.27,4.86-.66,7.27-.7,4.32-2.09,8.43-3.76,12.46Z"
              style={{
                fill: '#cacded',
              }}
            />
            <path
              className="neck_shadow"
              data-name="neck shadow"
              d="m615.5,222.9s-.42,47.72-.41,47.74c.39,1.17.59,2.98.68,5.14.14,3.2.06,7.16,0,10.99,33.22,21.73,62.1,24.05,88.83,2.32,0-.22.02-.44.03-.66.13-2.92.29-5.68.49-8.19.19-2.37.41-4.52.68-6.36.11-.75.23-1.47.36-2.11.01-.07.02-48.8.04-48.87-29.97,18.77-60.73,18.77-90.71,0Z"
              style={{
                fill: '#f0caa3',
              }}
            />
          ...
          <g className="face">
            ...
            <path
              className="nose"
              d="m650.25,195.43c12.69,5.2,23.34.9,23.79.71.81-.34,1.18-1.23.82-2-.35-.77-1.3-1.12-2.11-.78-.1.04-9.87,3.93-21.22-.72-.21-.08-.43-.13-.64-.13-.62,0-1.21.34-1.48.91-.35.77.02,1.66.83,2Z"
              style={{
                fill: '#e2b486',
              }}
            />
            <path
              className="mouth"
              d="m629.88,230.72c.37.3,9.33,7.31,24.64,8.74,2.22.21,4.39.3,6.49.3,12.21,0,21.7-3.02,22.17-3.17.79-.25,1.22-1.1.96-1.89s-1.1-1.22-1.89-.97c-.13.04-12.92,4.09-27.45,2.74-14.37-1.34-22.97-8.03-23.05-8.1-.65-.51-1.59-.41-2.11.24-.52.65-.41,1.59.24,2.11Z"
              style={{
                fill: '#b2926f',
              }}
            />
            ...
            <g className="eyeGroupClosed">
              <g className="left_eye_closed eye" data-name="left eye closed">
                <path
                  d="m614.68,165.74c-6.29,0-11.22-1.76-11.22-6.32,0-.83.59-1.5,1.32-1.5s1.32.67,1.32,1.5c0,2.79,3.93,3.32,8.57,3.32s8.57-.53,8.57-3.32c0-.83.59-1.5,1.32-1.5s1.32.67,1.32,1.5c0,4.57-4.93,6.32-11.22,6.32Z"
                  style={{
                    fill: '#2b343b',
                  }}
                />
              </g>
              <g className="right_eye_closed eye" data-name="right eye closed">
                <path
                  d="m705.85,166.06c-6.29,0-11.22-2.08-11.22-6.64,0-.83.59-1.5,1.32-1.5s1.32.67,1.32,1.5c0,2.79,3.93,3.64,8.57,3.64s8.57-.86,8.57-3.64c0-.83.59-1.5,1.32-1.5s1.32.67,1.32,1.5c0,4.57-4.93,6.64-11.22,6.64Z"
                  style={{
                    fill: '#2b343b',
                  }}
                />
            ...
            <path
              className="left_eyebrow"
              data-name="left eyebrow"
              d="m629.81,124.35c-.28,0-.56-.06-.84-.17-14.86-6.45-27.65-1.05-27.78-.99-1.06.46-2.3-.02-2.77-1.09-.46-1.06.02-2.3,1.08-2.77.59-.26,14.53-6.22,31.14.98,1.07.46,1.56,1.7,1.09,2.77-.34.79-1.12,1.27-1.93,1.27Z"
              style={{
                fill: '#b2926f',
              }}
            />
            <path
              className="bangs"
              d="m792.11,92.51c-5.3-25.11-3.26-22.93-17.04-43.6-3.55-4.44-6.61-8.68-11.33-13.78-5.63-6.07-9.78-9.97-22.48-14.73-5.31-1.99-14.88-2.09-20.54-1.8-1.75.09-2.83-.28-4.02-1.4-.39-.37-1.45-.75-2.89-1.12.04-.1.08-.18.08-.18-2.74-1.77-5.81-3.01-8.9-4.18-4.46-1.7-9.05-3.13-13.73-4.3-7.15-1.79-14.29-3.57-21.57-4.88-5.44-.98-10.93-1.71-16.47-2.15-1.45-.11-2.97.11-4.38-.39h-11.27c-.3.3-.71.22-1.08.21-2.35-.08-4.68.25-6.98.52-7.07.85-14.01,2.23-20.83,4.13-6.8,1.89-13.31,4.34-19.55,7.31-5.26,2.51-10.31,5.33-15.11,8.48-4.46,2.92-8.82,5.97-12.81,9.37l9.08,94.9c2.9.56,12.24,4.36,18.62,3.58-.02,0,0,0,.03-.01.52,0,1.04.01,1.57,0,4.56-.09,8.99-.83,13.14-2.49,1.39-.55,2.74-1.21,4.06-1.97.56-.33,1.12-.67,1.66-1.03.92-.6,1.79-1.26,2.65-1.94,2.21-1.9,3.32-2.98,4.48-4.21.93-1.02,1.82-2.09,2.66-3.21,1.68-2.23,3.22-4.53,4.66-6.89s2.8-4.78,4.11-7.22c.87-1.63,1.72-3.28,2.56-4.93,1.27-2.5,2.53-5,3.82-7.49,1.29-2.49,2.6-4.97,3.96-7.42,1.94-3.48,3.96-6.91,6.22-10.19.75-1.09,1.53-2.16,2.34-3.22,4.25-5.52,25.61-12.18,31.11-14.31,3.85-1.49,7.7-2.97,11.42-4.77.95-.46,1.43-.24,1.87.7.53,1.12,1.04,2.26,1.64,3.35,3.8,6.93,7.47,7.08,11.51,13.56,1.22,2.1,2.43,4.2,3.57,6.34.1.18.19.36.29.53.22.41.46.8.69,1.21.18.31.35.62.53.92.3.5.6.99.9,1.48.16.26.32.53.48.79.38.61.77,1.21,1.15,1.82.56.88,1.11,1.75,1.66,2.63,1.39,2.23,2.84,4.43,4.3,6.61,1.46,2.18,2.94,4.36,4.41,6.54,1.17,1.75,2.4,3.45,3.67,5.12,1.26,1.68,2.55,3.33,3.89,4.94.89,1.08,1.8,2.15,2.71,3.2,1.72,1.98,3.52,3.88,5.44,5.64.96.88,1.95,1.73,2.97,2.54,1.02.81,2.07,1.58,3.17,2.31,1.9,1.27,3.89,2.41,5.93,3.45.68.35,1.37.68,2.06,1.01,2.26,1.07,4.55,2.07,6.8,3.17.36.18.74.32,1.11.43"
              style={{
                fill: '#f4f0ca',
              }}
            />
          ...
          <g className="body">
            ...
            <g className="clothes">
              <g>
                <path
                  d="m846.12,613.14c-3.71.01-7.42.02-11.13.03,9.37-5.51,15.27-12.72,16.98-24.31,1.95-13.28-9.64-30.63-23.06-31.19-2.65-.11-45.93-.15-48.41-1.12.05-.29-152.91-159.92-155.75-162.84,13.63-2.44,120.49-35.02,135.03-59.89,8.51,3.7,58.15,8.4,72.98,29.29,26.49,37.31,27.12,100.41,28.72,113.12,3.16,25.03,4.2,50.09,4.25,75.26.02,12.55-4.29,24.06-8,35.72-2.88,9.06-5.97,18.07-11.6,25.92Z"
                  style={{
                    fill: '#2e338a',
                  }}
                />
                <path
                  d="m579.81,328.84c1.33-.31,2.67-.62,4-.93,23.67,30.08,54.16,49.46,91.34,58.45,6.56,1.59,13.16,2.7,19.89,3.03-1.24,1.61-3.01,1.06-4.59,1.06-57.22.03-186.85,175.93-188.19,177.44-3.13.04-17.88-10.21-21.01-10.14-17.24.39-30.15,17.61-25.4,35.23,2.52,9.33,8.45,15.82,16.91,20.19-4.58.01-9.16.02-13.73.03-7.34-11.42-12.16-23.85-15.12-37.07-.75-3.35-1.51-6.8-2.94-9.89-2.28-4.92-1.76-10-1.82-15.1-.21-18.48.14-36.97,2.1-55.34,2.81-26.28,6.18-52.5,13.3-78.05,2.26-8.11,4.16-16.3,6.76-24.34,1.34-4.14.63-8.98,2.59-13.41,2.85-6.44,7.39-11.32,12.71-15.53,10.28-8.14,22.16-13.35,34.38-17.81,20.98-7.66,42.77-12.19,64.6-16.53,1.44-.29,2.82-.84,4.23-1.27Z"
                  style={{
                    fill: '#2e338a',
                  }}
                />
                <path
                  d="m490.65,557.61c5.34.72,3.32,2.92,3.34,4.63.08,7.38-2.36,15.2-2.26,22.57.12,8.62,5.08,14.85,10.54,20.79-4.23,1-8.48,1.98-7.43,7.92-7.36-.13-14.71-.25-22.07-.38-8.46-4.37-14.39-10.86-16.91-20.19-4.75-17.62,8.16-34.83,25.4-35.23,3.13-.07,6.26-.08,9.4-.12Z"
                  style={{
                    fill: '#e5b28c',
                  }}
                />
                <path
                  d="m817.64,613.5c.9-5.69-3.22-6.88-7.27-8.15,9.52-7.08,10.89-17.11,10.38-27.98-.32-6.88-.11-13.78-.14-20.67.22.02.43-.03.61-.16,2.48.97,5.04,1.01,7.69,1.12,13.42.56,25.02,17.91,23.06,31.19-1.71,11.59-7.61,18.8-16.98,24.31-5.78.11-11.57.22-17.35.33Z"
                  style={{
                    fill: '#e5b28c',
                  }}
                />
          ...
          <g className="table">
            ...
            <g className="coffee">
              ...
              <g className="smoke1 smoke-wrap">
                ...
                />
                <path
                  className="coffesmoke-2 smoke2"
                  data-name="coffesmoke"
                  d="m271.21,500.92s-7.1,2.17-9.83,9.66c-4.35,11.91,3.16,17.29,3.16,17.29,7.17,3.92,13.74,8.62,11.1,15.15-2.09,5.19-3.84,4.26-10.92,10.67,4.18-.12,6.37-.38,8.88-.58,3.86-2.08,7.19-9.49,7.19-9.49,0,0,1.82-11.56-4.39-15.59-.82-.53-1.72-.95-2.66-1.2-2.48-.66-8.3-2.66-8.69-7.2-.23-2.7-1.02-7.26-.06-10.71.68-2.43,1.11-2.11,6.21-8Z"
                  style={{
                    fill: '#a0a0a0',
                    opacity: 0.25,
                  }}
              ...
              <g className="smoke2 smoke-wrap">
                <path
                  className="coffesmoke-3 smoke3"
                  data-name="coffesmoke"
                  d="m259.88,553.89c-3.96-5.96-.7-7.66,5.55-11.55.83-.51,1.72-.92,2.67-1.17,2.48-.66,8.38-1.48,8.86-5.72.29-2.53.98-5.81.08-9.01-.63-2.25-1.35-4.94-3.3-11.85,0,0,4.41,4.23,6.98,11.16,4.08,11.03-3.49,16.2-3.49,16.2-7.21,3.8-12.03,5.08-10.6,11.46"
                  style={{
                    fill: '#a0a0a0',
                    opacity: 0.25,
                  }}
                />
                <path
                  className="coffesmoke-4"
                  data-name="coffesmoke smoke4"
                  d="m242.78,492.34s7.3,2.84,10.42,11.62c4.96,13.96-2.4,19.83-2.4,19.83-7.09,4.19-13.53,9.32-10.55,16.99,2.36,6.09,4.09,5.1,11.57,12.83-4.25-.33-6.47-.73-9.03-1.08-4.01-2.58-7.73-11.3-7.73-11.3,0,0-2.38-13.43,3.72-17.81.81-.58,1.7-1.02,2.64-1.26,2.49-.64,8.29-2.69,8.48-7.91.11-3.11.7-8.34-.44-12.37-.8-2.84-1.22-2.49-6.67-9.53Z"
                  style={{
                    fill: '#a0a0a0',
                    opacity: 0.25,
                  }}
